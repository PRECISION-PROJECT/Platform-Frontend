...
const CreateProductFormKeywordUI = ({ isPending }: Props) => {
  const { control, setValue } = useFormContext<CreateProductFormData>();
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex justify-between gap-4">
        ...
        />
        <Button className="shrink-0" onClick={addKeyword} type="button" disabled={isPending}>
...
export default CreateProductFormKeywordUI;
