...
const HeroSectionUI = () => {
  return (
    <div className="relative w-full h-[55vh] md:h-[65vh] xl:h-[520px]">
      {/* Background image */}
      <Image
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
        <p className="text-xs sm:text-sm font-light mb-4">HOME / ABOUT US</p>
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 pointer-events-none">
        <span className="text-10xl md:text-12xl lg:text-18xl font-medium text-white/5 tracking-wider whitespace-nowrap text-stroke">
